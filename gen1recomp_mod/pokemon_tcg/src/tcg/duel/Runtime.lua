...
local Memory = require("mods.pokemon_tcg.src.tcg.memory.Memory")
local DuelVars = require("mods.pokemon_tcg.src.tcg.duel.DuelVars")
local RNG = require("mods.pokemon_tcg.src.tcg.duel.RNG")
local CardData = require("mods.pokemon_tcg.src.tcg.duel.CardData")
local DuelOps = require("mods.pokemon_tcg.src.tcg.duel.DuelOps")
local Core = require("mods.pokemon_tcg.src.tcg.duel.Core")
local DeckLoader = require("mods.pokemon_tcg.src.tcg.duel.DeckLoader")
local DuelSetup = require("mods.pokemon_tcg.src.tcg.duel.DuelSetup")
local SaveData = require("mods.pokemon_tcg.src.tcg.duel.SaveData")
local Practice = require("mods.pokemon_tcg.src.tcg.duel.Practice")
local AI = require("mods.pokemon_tcg.src.tcg.duel.AI")
local Status = require("mods.pokemon_tcg.src.tcg.duel.Status")
local EffectCommands = require("mods.pokemon_tcg.src.tcg.duel.EffectCommands")
local Prizes = require("mods.pokemon_tcg.src.tcg.duel.Prizes")
local KnockOuts = require("mods.pokemon_tcg.src.tcg.duel.KnockOuts")
local DuelInterface = require("mods.pokemon_tcg.src.tcg.duel.DuelInterface")
local TurnFlow = require("mods.pokemon_tcg.src.tcg.duel.TurnFlow")
local Combat = require("mods.pokemon_tcg.src.tcg.duel.Combat")
local PlayerActions = require("mods.pokemon_tcg.src.tcg.duel.PlayerActions")
